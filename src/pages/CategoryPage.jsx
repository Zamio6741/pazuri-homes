    ...
    subcategories: [
      {
        name: "Sofa Sets",
        description:
          "Complete sofa combinations for stylish living spaces.",
      },
      {
        name: "TV Units",
        description:
          "Modern TV units designed to organize and elevate your entertainment area.",
      },
      {
        name: "Coffee Tables",
        description:
          "Stylish coffee tables made to complement your living room.",
      },
      {
        name: "Console Tables",
        description:
          "Elegant console designs for entryways and living spaces.",
      },
      {
        name: "Side Tables",
        description:
          "Compact and practical tables for everyday use.",
      },
    ],
  },
    ...
    subcategories: [
      {
        name: "Beds",
        description:
          "Custom beds designed around your preferred style and size.",
      },
      {
        name: "Wardrobes",
        description:
          "Fitted and freestanding wardrobes built around your storage needs.",
      },
      {
        name: "Bedside Tables",
        description:
          "Practical bedside storage designed to complement your bedroom.",
      },
      {
        name: "Dressing Tables",
        description:
          "Beautiful dressing tables with functional storage solutions.",
      },
    ],
  },
    ...
    subcategories: [
      {
        name: "Dining Tables",
        description:
          "Custom dining tables made to fit your space.",
      },
      {
        name: "Dining Sets",
        description:
          "Complete dining combinations designed for your home.",
      },
      {
        name: "Dining Chairs",
        description:
          "Comfortable dining chairs crafted to complement your table.",
      },
    ],
  },
    ...
    subcategories: [
      {
        name: "Office Desks",
        description:
          "Functional desks designed for modern workspaces.",
      },
      {
        name: "Office Chairs",
        description:
          "Comfortable seating solutions for your workspace.",
      },
      {
        name: "Office Cabinets",
        description:
          "Smart storage solutions for organized offices.",
      },
      {
        name: "Reception Furniture",
        description:
          "Professional furniture designed for welcoming reception areas.",
      },
    ],
  },
    ...
    subcategories: [
      {
        name: "Shoe Cabinets",
        description:
          "Clean and practical storage for your footwear.",
      },
      {
        name: "Shoe Racks",
        description:
          "Simple and functional shoe storage solutions.",
      },
      {
        name: "Shelves",
        description:
          "Custom shelving designed for display and storage.",
      },
      {
        name: "Storage Cabinets",
        description:
          "Versatile cabinets made around your storage requirements.",
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        description:
          "Custom cabinets designed around your kitchen layout.",
      },
      {
        name: "Pantry Cabinets",
        description:
          "Organized pantry storage designed to maximize your space.",
      },
      {
        name: "Kitchen Storage",
        description:
          "Practical storage solutions for modern kitchens.",
      },
    ],
  },
    ...
    subcategories: [
      {
        name: "Mirrors",
        description:
          "Stylish mirror designs for different spaces.",
      },
      {
        name: "Wall Décor",
        description:
          "Custom pieces designed to enhance your walls and interiors.",
      },
      {
        name: "Shelves",
        description:
          "Decorative and functional shelving solutions.",
      },
      {
        name: "Home Accessories",
        description:
          "Unique pieces that add personality to your home.",
      },
    ],
  },
    ...
    subcategories: [
      {
        name: "Custom Pieces",
        description:
          "Unique furniture created from your own idea or inspiration.",
      },
      {
        name: "Made-to-Measure Furniture",
        description:
          "Furniture designed and built specifically for your available space.",
      },
    ],
  },
}
...
function CategoryPage() {
  ...
  if (!categoryData) {
    return (
      <section className="min-h-screen bg-stone-50 px-5 py-20 sm:px-8 lg:px-12">
